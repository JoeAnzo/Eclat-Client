    ...
    <section className="min-h-screen">
      {
        ...
        <div className="flex flex-col gap-2 t-8">
          ...
          <div className="sticky py-1.5 bottom-0 flex flex-col gap-2 items-center justify-center bg-[#F5F5F5]">
              <Button size="lg" variant="default" className="bg-(--primary-color) h-12 px-8 font-semibold text-lg shadow-lg tracking-wide text-white flex gap-2 rounded-none">
                CheckOut (UGX {totalPrice.toLocaleString()})
              </Button>
              <Button onClick={() => clearCart()} size="lg" variant="default" className="bg-(--primary-color) h-12 px-8 font-semibold text-lg shadow-lg tracking-wide text-white flex gap-2 rounded-none">
                Clear Cart
              </Button>
          </div>
        </div>
