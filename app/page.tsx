...
export default function Home() {
  ...
  return (
    <main className="relative">
      <div className="fixed bottom-5 right-5 h-15 w-15 rounded-full bg-[#25D366] flex items-center justify-center z-150 transition-transform duration-200 before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-[#25D366] before:animate-wa-ripple">
