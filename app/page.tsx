  ...
  return (
    <main>
      <section className="relative">
        <Couresel/>
        <div className="absolute left-[50%] -translate-x-[50%] -translate-y-[50%] top-[50%] z-5">
           <h2 className="sm:text-4xl text-2xl font-playfair text-(--primary-color) my-4">Your Essence, Your Signature</h2>
           ...
           <div className="flex flex-col gap-2 justify-start items-left  bg-red">
            <Button size="lg" variant="secondary" className="bg-(--primary-color) text-white px-2 flex gap-2">
              Shop now
              <ArrowRight/>
            </Button>
            <Button variant="outline" size="lg" className="px-2 flex gap-2">
              <Play />
              How it works
            </Button>
           </div>
